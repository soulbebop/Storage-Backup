...
### バックアップ結果と照会
バックアップ計画リストからバックアップ計画をクリックすると、バックアップ結果を照会できます。バックアップ結果は、バックアップ完了時刻から最長1時間以内に集計されます。
...
サーバーを削除する前に、必ず登録したバックアップ計画を削除する必要があります。登録されたバックアップ計画がある場合、案内メッセージが表示され、削除が中断されます。
